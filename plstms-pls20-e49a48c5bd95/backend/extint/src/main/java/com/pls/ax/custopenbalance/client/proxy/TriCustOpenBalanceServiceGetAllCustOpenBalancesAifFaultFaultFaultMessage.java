...
public class TriCustOpenBalanceServiceGetAllCustOpenBalancesAifFaultFaultFaultMessage
    extends Exception {
     ...
     * @param message
     */
    public TriCustOpenBalanceServiceGetAllCustOpenBalancesAifFaultFaultFaultMessage(String message, AifFault faultInfo) {
        super(message);
