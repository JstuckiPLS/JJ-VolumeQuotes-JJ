...
@XmlType(name = "ArrayOfKeyValueOfstringstring", namespace = "http://schemas.microsoft.com/2003/10/Serialization/Arrays",
    propOrder = {
...
public class ArrayOfKeyValueOfstringstring {
     ...
     * the keyValueOfstringstring property.
     *
     * <p>
     ...
     *
     * @return A list of ArrayOfKeyValueOfstringstring.KeyValueOfstringstring instances.
     *
     */
    ...
    public static class KeyValueOfstringstring {
        ...
        @XmlElement(name = "Key", namespace = "http://schemas.microsoft.com/2003/10/Serialization/Arrays", required
            = true, nillable = true)
        protected String key;
        @XmlElement(name = "Value", namespace = "http://schemas.microsoft.com/2003/10/Serialization/Arrays", required
            = true, nillable = true)
