...
/**
 * Test Generates CBI 'Flex Version' report as .xlsx file.
 * 
 * @author Dmitry Nikolaenko
 * 
 */
@RunWith(MockitoJUnitRunner.class)
public class CBIFlexVersionExcelReportBuilderTest {
    ...
    @Before
    public void setUp() {
        flexVersionReport = new ClassPathResource("templates/CBI_flex_version.xlsx");
    ...
    @Test
    public void generateFlexVersionExcelReportTest() throws IOException, ParseException {
        CBIFlexVersionExcelReportBuilder builder = new CBIFlexVersionExcelReportBuilder(flexVersionReport);
        List<LoadAdjustmentBO> invoices = new ArrayList<LoadAdjustmentBO>();
        invoices.add(new LoadAdjustmentBO(getLoad()));

        builder.generateReport(getBillTo(), invoices, new Date(), String.valueOf(new Random().nextInt(10000)), new FileOutputStream(testReport));
    ...
    private BillToEntity getBillTo() {
        ...
        billTo.getBillingInvoiceNode().setAddress(address);
