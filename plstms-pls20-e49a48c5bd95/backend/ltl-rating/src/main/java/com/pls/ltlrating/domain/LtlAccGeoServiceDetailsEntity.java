...
/**
 * LtlAccGeoServiceDetailsEntity.
 *
 * @author Pavani Challa
 *
 */
@Entity
@Table(name = "LTL_ACC_GEO_SERV_DTLS")
public class LtlAccGeoServiceDetailsEntity implements Identifiable<Long>, HasModificationInfo {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ltl_acc_geo_serv_dtl_seq")
    @SequenceGenerator(name = "ltl_acc_geo_serv_dtl_seq",
                       sequenceName = "LTL_ACC_GEO_SERV_DTL_SEQ", allocationSize = 1)
    @Column(name = "LTL_ACC_GEO_SERV_DTL_ID")
    private Long id;

    @Column(name = "LTL_ACC_GEO_SERVICE_ID", nullable = false, insertable = false, updatable = false)
    private Long ltlAccGeoServiceId;
    ...
    @JoinColumn(name = "LTL_ACC_GEO_SERVICE_ID", nullable = false)
    @JsonIgnore
    private LtlAccGeoServicesEntity geoService;
     ...
     * Default Constructor.
     */
    public LtlAccGeoServiceDetailsEntity() {
    }
     ...
     */
    public LtlAccGeoServiceDetailsEntity(LtlAccGeoServicesEntity geoService, String geoValue, GeoType geoType,
            int geoServType, String geoValueSearchable) {
        this.geoService = geoService;
        this.geoValue = geoValue;
        this.geoType = geoType;
        this.geoServType = geoServType;
        this.ltlAccGeoServiceId = geoService.getId();
     ...
     */
    public LtlAccGeoServiceDetailsEntity(LtlAccGeoServiceDetailsEntity source, LtlAccGeoServicesEntity geoService) {
    ...
    public Long getLtlAccGeoServiceId() {
        return ltlAccGeoServiceId;
    }

    public void setLtlAccGeoServiceId(Long ltlAccGeoServiceId) {
        this.ltlAccGeoServiceId = ltlAccGeoServiceId;
    }
    ...
    public LtlAccGeoServicesEntity getGeoService() {
        return geoService;
    }

    public void setGeoService(LtlAccGeoServicesEntity geoService) {
        this.geoService = geoService;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final LtlAccGeoServiceDetailsEntity other = (LtlAccGeoServiceDetailsEntity) obj;
